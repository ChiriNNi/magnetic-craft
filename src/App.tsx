      ...
      <main>
        ...
        <section className="section catalog-section pixel-grid" id="catalog">
          <div className="section-heading reveal">
            ...
            <p>Полный каталог скоро появится отдельной страницей. Пока можно посмотреть хиты и открыть карточку набора.</p>
          </div>
          ...
          <div className="catalog-more reveal">
            <a
              className="pixel-button secondary"
              href="/catalog"
              aria-label="Перейти на будущую страницу полного каталога наборов"
            >
              🧱 Смотреть все наборы
            </a>
            <p>Скоро здесь будет отдельный каталог с фильтрами, фото и всеми комплектами.</p>
          </div>
        </section>
